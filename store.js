...
async function initStore() {
    ...
    try {
        ...
        // Fetch products from Cloudflare API
        const response = await fetch('https://jorobean.pages.dev/api/products');
...
async function showProductDetails(productId) {
    try {
        ...
        const response = await fetch(`https://jorobean.pages.dev/api/variants?id=${productId}`);
        const data = await response.json();
